	...
	\begin{tikzpicture}[
		...
		\newcommand{\AREA}[8]{
			\begin{scope}[rotate=#4, transform shape, rot/.style={
				...
				\LogNode{as\t1}{tier1}{#4}
				\node[rot, tier 1, below=4mm of #3] (as\t2) {\t2};
				\LogNode{as\t2}{tier1}{#4}
		...
		evaluate=\i as \j using {int(Mod(\i,\zones)+1)},
			...
			\AREA{\start}{\asPerZone}{branch\i}{\rotate}{ixp\ixp{0}}{ixp\ixp{\i}}{ixp\ixp{\j}}{\theta}
		};
